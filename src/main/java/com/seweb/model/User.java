...
public class User {
    ...
    public String getPreferredCuisineType() { return preferredCuisineType; }
    public void setPreferredCuisineType(String preferredCuisineType) { this.preferredCuisineType = preferredCuisineType; }
    ...
    public String toString() {
        return "User{id=" + id + ", name=" + name + " " + surname
                + ", skill=" + cookingSkillLevel + ", cuisine=" + preferredCuisineType + "}";
    }
}
